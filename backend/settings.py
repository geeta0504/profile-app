...
SECRET_KEY = 'django-insecure-sh9lwd50d-&hu)ex%y^md*wcu-4m%dduyx9kmy2svo5bswsjck'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False


ALLOWED_HOSTS = ['your-backend-domain.com', '127.0.0.1']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '20/min',  # 20 requests per minute for anonymous users
        'user': '60/min',  # 60 requests per minute for authenticated users
    },
    'DEFAULT_PAGINATION_CLASS': 'rest_framework.pagination.PageNumberPagination',
    'PAGE_SIZE': 10,       # pagination: 10 items per page
}
